...
📦 ITEM: ${preset.input}
📅 DATE: ${date}
🆔 AUDIT: #TE-${new Date().getFullYear()}-${String(Math.floor(Math.random() * 100000)).padStart(5, '0')}
...
${preset.name}
${preset.current.rate} → ${preset.hack.newRate}
